    ...
    return (
        <div className="w-1/4">
            ...
            <div>
                ...
                <div>
                    <input className="bg-colorGreyScaleGrey5 placeholder:text-colorGreyScaleGrey3" type="text" placeholder="Mínima" />
                    <input className="bg-colorGreyScaleGrey5 placeholder:text-colorGreyScaleGrey3" type="text" placeholder="Máxima"/>
                </div>
            </div>
            <div>
                <h2 className="text-black text-2xl font-semibold">
                ...
                <div>
                    <input className="bg-colorGreyScaleGrey5 placeholder:text-colorGreyScaleGrey3" type="text" placeholder="Mínimo" />
                    <input className="bg-colorGreyScaleGrey5 placeholder:text-colorGreyScaleGrey3" type="text" placeholder="Máximo"/>
                </div>
            </div>
        </div>
    )
