      ...
      <div className="flex flex-col bg-colorColorsFixedWhiteFixed shadow min-h-full min-w-full p-10">
        ...
        <div className="mb-10 max-w-[343px] ">
          ...
          <div className="m-2 flex gap-5 ">
            <input
              className="input-sidebar placeholder:text-colorGreyScaleGrey3 w-full"
              type="text"
              placeholder="Mínima"
            />
            <input
        ...
        <button className="flex justify-center items-center m-5 bg-colorBrandBrand2 text-colorColorsFixedWhiteFixed py-3 rounded max-w-[279px]">
          Ver anúncios
        </button>
      </div>
    </div>
