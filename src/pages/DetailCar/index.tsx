            ...
            <section className="shadow-lg p-4 bg-colorColorsFixedWhiteFixed lg:max-h-[800px] lg:absolute lg:w-[60%] lg:max-w-[750px] lg:top-[900px] mt-36">
              ...
              <div>
                {car?.comments && car?.comments.length > 0 ? (
                  ...
                  <h2 className="bg-colorGreyScaleGrey7 w-full p-3 text-center rounded-md text-colorGreyScaleGrey3">
                    Sem Comentários
                  </h2>
                )}
                <form
                  onSubmit={handleSubmit}
                  className="flex flex-col gap-5 items-baseline mt-16 relative"
                >
                  {user && (
                  ...
                  <textarea
                    className="outline-none h-32 w-full p-2 resize-none border rounded-sm border-colorGreyScaleGrey4 text-colorGreyScaleGrey2"
                    value={text}
                  ...
                  {user ? (
                    <button
                      type="submit"
                      disabled={!text}
                      className="bg-colorBrandBrand1 text-colorColorsFixedWhiteFixed h-10 w-28 cursor-pointer border-none rounded-md lg:absolute lg:right-1 lg:bottom-12"
                    >
                      Comentar
                    </button>
                  ) : (
                    <button
                      className="bg-colorGreyScaleGrey5 text-colorColorsFixedWhiteFixed h-10 w-28 border-none rounded-md lg:absolute lg:right-1 lg:bottom-12"
                      disabled
                    >
                      Comentar
                    </button>
                  ...
                  <div className="flex flex-wrap gap-10 w-full">
                    <button
                      type="button"
                      onClick={() => addTextArea("Gostei muito!")}
